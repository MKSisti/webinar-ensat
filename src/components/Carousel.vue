      ...
      >
        ...
        <div class="h-16 md:h-20 left-0 bottom-0 absolute w-full group hover:h-20 md:hover:h-28 transition-all duration-300">
          ...
          <transition name="fade-y" appear>
            <div
              v-if="!loading"
              class="absolute left-0 transition duration-300 bottom-0 w-full h-full px-2 md:px-8 flex justify-start items-center z-50 opacity-80 group-hover:opacity-100"
            >
              <span
