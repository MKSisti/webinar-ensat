<template>
    <div v-if="userInfo.priv >= 1" class="w-full h-full transition-opacity duration-300 bg-gray-100 dark:bg-gray-900 flex justify-start items-start flex-col space-y-5 rounded-t-6xl shadow-3xl overflow-auto">
        ...
        <!-- //!Create post button -->
        <!-- <div class="flex justify-center items-center space-x-2 px-10" @click="goToCreate">
...
<script>
import { getUser, requestHost, checkUserInwaitingRoom, getPosts, getFollowingListIds, makeUsersMap } from "../js/dbActions.js";
