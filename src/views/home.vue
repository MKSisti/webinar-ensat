    ...
    >
      ...
      <div
        class="
          ...
          justify-start
          items-center
          xl:justify-between xl:items-start xl:space-x-10
        "
      >
        <div
          class="
        ...
        <search
          ...
          class="
            w-full
            bg-gray-50
            md:bg-gray-100 md:8/12
            sm:mb-10
            xl:w-5/12
            md:w-7/12
            order-1
            xl:order-2 xl:top-10 xl:sticky
            border-0 border-b-2 border-gray-200 border-opacity-70
            sm:border-b-0
          "
        />
      </div>
    ...
    async doSearch() {
      if (this.keyword != "") {
        ...
        this.posts = await getPosts(
          { approved: true, title: this.keyword },
