<template>
  <div ref="home" class="flex flex-col justify-start items-center sm:space-y-10 xl:pt-10">
    ...
    >
      ...
      >
        <post-card :key="p.pid" v-for="p of posts" :post="p" :userData='usersMap.get(p.owner)' @click="goToPost(p.pid)" />
      </div>
      <search
...
import { getInitialPosts, getExtraPosts, makeUsersMap } from "../js/firebaseActions";
